...
def main():
    ...
    axes[0, 0].imshow(image_reshape(img_vec), cmap='gray')
    axes[0, 0].set_title('Original Image')
    axes[0, 0].axis('off')

    axes[0, 1].imshow(image_reshape(img_reconstruct_pca), cmap='gray')
    axes[0, 1].set_title('Reconstructed Image with PCA')
    axes[0, 1].axis('off')

    axes[1, 0].imshow(image_reshape(img_reconstruct_ae), cmap='gray')
    axes[1, 0].set_title('Reconstructed Image with Autoencoder')
    axes[1, 0].axis('off')

    axes[1, 1].imshow(image_reshape(img_reconstruct_deno_ae), cmap='gray')
    axes[1, 1].set_title('Reconstructed Image with DenoisingAutoencoder')
    axes[1, 1].axis('off')
